  ...
  <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
    <div class="mx-auto max-w-md">
      <div class="rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8">
        ...
        <p class="mt-2 text-sm text-slate-300">Use your admin email and password. This portal is for registrar tools (student lookup, schedule, holds), not the student site.</p>
