    ...
    <div class="mx-auto max-w-md">
      <div class="rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8">
        <div class="flex flex-wrap items-center gap-2">
          ...
          <span class="rounded-full border border-white/10 bg-white/5 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-slate-400">Portal</span>
        </div>
        <h1 class="mt-2 text-2xl font-semibold tracking-tight text-white">Create account</h1>
        <p class="mt-2 text-sm text-slate-300">Creates an <strong class="font-semibold text-slate-200">admin</strong> login so you can open the dashboard. Password must be at least 8 characters.</p>
