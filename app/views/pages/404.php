  ...
  <div class="mx-auto max-w-6xl px-4 py-20 sm:px-6">
    <div class="mx-auto max-w-lg text-center">
      ...
      <p class="mt-4 text-sm text-slate-400">
        ...
        Try <strong class="font-semibold text-slate-300">Admin sign in</strong> below, or the home page.
      </p>
      <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
        ...
        <a class="rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-100 hover:bg-white/10" href="<?= htmlspecialchars(url('/login.php')) ?>">Admin sign in</a>
      </div>
    </div>
  </div>
</section>
